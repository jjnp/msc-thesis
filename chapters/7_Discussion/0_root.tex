...
\include{chapters/7_Discussion/1_lb_impl_parametrization}
\include{chapters/7_Discussion/2_lb_resources_scale}
\include{chapters/7_Discussion/3_osmotic}
\include{chapters/7_Discussion/4_osmotic_implications}
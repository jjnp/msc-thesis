...
\setdate{19}{04}{2022} % Set date with 3 arguments: {day}{month}{year}.
...
\begin{kurzfassung}
% \todo{Ihr Text hier.}
\input{chapters/0_Abstract/abstract_de}
\end{kurzfassung}

\begin{abstract}
\input{chapters/0_Abstract/abstract_en}
\end{abstract}
...
\input{chapters/1_Introduction/0_root}
\input{chapters/2_Background/0_root}
\input{chapters/3_Related_Work/0_root}
\input{chapters/4_Approach/0_root}
\input{chapters/5_Methodology/0_root}
\input{chapters/6_Evaluation/0_root}
\input{chapters/7_Discussion/0_root}
\input{chapters/8_Conclusion/0_root}
